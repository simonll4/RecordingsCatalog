...
class BoTSORTTracker:
    ...
    def __init__(self, config_path: str = "botsort.yaml"):
        ...
        try:
            ...
            logger.info(f"Tracker config: match_thresh={self.match_thresh}, max_age={self.max_age}")
        except Exception as e:
            logger.warning(f"No se pudo cargar config de tracker: {e}. Usando defaults.")
